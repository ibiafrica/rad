...
class Settings_app extends Admin	
{
	...
	*/
	public function add_save()
	{
		...
		$this->form_validation->set_rules('NIF_ENTREPRISE', 'NIF', 'trim|required');
		$this->form_validation->set_rules('RC_ENTREPRISE', 'RC', 'trim|required');
		$this->form_validation->set_rules('TVA_ENTREPRISE', 'Type TVA', 'trim|required');
		...
		if ($this->form_validation->run()) {
			...
			$save_data = [
				...
				'TVA_ENTREPRISE' => $this->input->post('TVA_ENTREPRISE'),
	...
	*/
	public function delete($id = null)
	{
		...
		// if (!empty($id)) {
			$remove = $this->db->query('DELETE FROM settings_app WHERE ID_SETTING='.$id);
		//}
