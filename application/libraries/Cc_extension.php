...
class Cc_Extension
{
	...
	protected $extensionListUrl = 'https://raw.githubusercontent.com/ibibuilder/cc-extension/master/extensions.json';
...
class Cc_Extension_item
{
	...
	{
		ibi()->eventListen('extension_info_'.$this->getExtName());
	}
