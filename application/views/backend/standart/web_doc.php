...
<div class="wrapper">
   <header class="doc-header">
      <div class="container">
         <h2 class="lone-header">Ibi WEB Documentation V-1.18</h2>
      </div>
   </header>
   <section class="doc-content">
      <div class="container">
         <ul class="docs-nav">
            ...
            <li><a href="#cc_app" class="cc-active">Ibi App</a></li>
            <li class="separator"></li>
         ...
         <div class="docs-content">
            ...
            <p> Ibi is a multifunctional application that is used to facilitate your work in creating a system, CMS, E-Comerce and others</p>
