                     ...
                     <!--  <td><?//= _ent($pos_ibi_commandes->PRIX_TOTAL); ?> Fbu</td> -->
                      ...
                      <td width="100">
                        ...
                        <?php is_allowed('pos_ibi_commandes_view', function () use ($pos_ibi_commandes) { ?>
                          <a style="margin-right: 2px" data-title="paiement" href="<?= site_url('administrator/pos_ibi_commandes/debloquer_facture/' . $pos_ibi_commandes->ID_pos_IBI_COMMANDES); ?>" class="btn bg-green btn-xs" title="Debloquer"><i class="fa fa-arrow-left"></i></a>
                        <?php }) ?>
                      </td>
                    </tr>
                              ...
                              <?php foreach ($pos_ibi_commandes->BON as $bon_cmd) : ?>
                                ...
                                <?php foreach ($bon_cmd as $prod) : ?>
                                  <div style="width: 100%;display: flex;justify-content:space-between">
                                    ...
                                    <p><?= (($prod->QUANTITE * $prod->PRIX) - (($prod->QUANTITE * $prod->PRIX) * $prod->DISCOUNT_PERCENT / 100)); ?></p>
                                  </div>
                                <?php endforeach; ?>
                                </br>
                                </hr>
