                    ...
                    <ul class="list-group">
                      ...
                      <li class="list-group-item bg-danger">
                       ...
                       <?php foreach ($produits as $k) {
                           ...
                           <li class="list-group-item" id="list_item_<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>">
                           ...
                           <div class="row">
                               ...
                               <?php 
                                 ...
                                 $store = $k->STORE_POS_IBI_COMMANDES_PRODUITS;
                            ...
                            <div class="col-md-1">
                               ...
                               <input type="hidden" name="quantite[]" class="quantite_<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>" value="<?php echo  $k->QUANTITE; ?>">
                             ...
                             <div class="col-md-1">
                                ...
                                <span class="prix_ti_<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>"> <?php echo $k->PRIX;  ?></span>

                                <input type="hidden" name="prix[]" class="prix_<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>" value="<?php echo  $k->PRIX; ?>">
                            ...
                            <div class="col-md-1">
                                ...
                                <span class="prix_tot_<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>"><?php echo $k->PRIX_TOTAL;  ?></span>

                                <input type="hidden" name="prix_total[]" class="prix_total prix_total_<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>" value="<?php echo  $k->PRIX_TOTAL; ?>">
                               ...
                               <div class="col-md-1">
                                 ...
                                 <input style="border-color:#c4c4c4 !important;border:1px solid #c4c4c4;" name="discount[]" class="it item_<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>" type="number" min="0" value="0" onchange="remise(<?php  echo $k->POS_IBI_COMMANDES_PRODUITS; ?>)" onkeyup="remise(<?php  echo $k->POS_IBI_COMMANDES_PRODUITS; ?>)">

                                 <input type="hidden" name="produit_id[]" value="<?php echo $k->POS_IBI_COMMANDES_PRODUITS; ?>">
