...
<section class="content-header">
  <h1>
   Commande void to request </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Commande void to request</li>
  </ol>
</section>
<!-- Main content -->
          ...
          <form name="form_POS_ibi_commandes" id="form_POS_ibi_commandes" action="<?= base_url('administrator/pos_ibi_commandes/void_to_request'); ?>">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12" style="float:;">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="q" id="filter" placeholder="<?= 'Recherher par nom du serveur'; ?>" value="<?= $this->input->get('q'); ?>">
                </div>
                ...
                <div class="col-sm-2" style="border: 0px solid;">
                  ...
                  <div class="col-sm-12 padd-left-0 ">
                    ...
                    <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= site_url('administrator/pos_ibi_commandes/void_to_request'); ?>" title="Réinitialiser la recherche">
                    ...
                    <tr>
                      ...
                      <td><?php
                          ...
                          ?></td>
                           ...
                           <td><?= _ent($pos_ibi_commandes->DELETED_COMMENT_POS_IBI_COMMANDES);
                          ?></td>
                      ...
                      <td width="100">
                        ...
                        <?php //endif; ?>
                        <button data-toggle="modal" data-target="#myModal<?= $pos_ibi_commandes->ID_POS_IBI_COMMANDES; ?>" style="margin-right: 2px" data-title="facture" data-id="<?php echo $pos_ibi_commandes->ID_POS_IBI_COMMANDES ?>" class="btn_produit_data btn btn-default btn-xs"><i class="fa fa-th-list"></i></button>
                        ...
                        <?php /*if ($pos_ibi_commandes->TO_WHOM == 0) : ?>
                        ...
                        <!-- <button data-toggle="modal" data-target="#myModalbon<?php echo $pos_ibi_commandes->ID_POS_IBI_COMMANDES ?>" style="margin-right: 2px" data-title="Bon de commandes" data-id="" class="btn btn-success btn-xs" title="bons"><i class="fa fa-list"></i></button> -->
                          ...
                          if ($pos_ibi_commandes->DELETED_STATUS_POS_IBI_COMMANDES == 0) : ?>

                          <?php is_allowed('access_to_void', function () use ($pos_ibi_commandes) { ?>
                            <a class="btn btn-danger btn-xs remove-data" data-href="<?= base_url('administrator/pointdesventes/delete/0') . "/" . $pos_ibi_commandes->ID_POS_IBI_COMMANDES . "/0" ?>">
