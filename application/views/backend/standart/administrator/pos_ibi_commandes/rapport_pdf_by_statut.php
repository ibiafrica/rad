      ...
      <div class="box box-warning">
        ...
        <br>
                ...
                <?php  foreach ($commande as $k) { ?>
                    ...
                    <tr>
                    <td colspan="4" style="height:40px;color:white !important;background:gray !important;padding:5px"> <strong style="font-color:white !important">
                     <?php 
                     $donnee= $this->db->get_where('pos_clients',array('ID_CLIENT'=>$k->CLIENT_ID_COMMANDE));
                     echo $donnee->row()->NOM_CLIENT.''.$donnee->row()->PRENOM
                      ?> - <?php echo $k->CODE ?>
                    </strong></td>
                    </tr>
                    <br>
