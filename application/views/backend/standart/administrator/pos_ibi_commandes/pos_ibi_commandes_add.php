...
<section class="content-header">
    ...
    <h1>
        ...
        Pos Ibi Commandes        <small><?= cclang('new', ['Pos Ibi Commandes']); ?> </small>
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pos Ibi Commandes']); ?></h5>
    ...
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          ...
          url: BASE_URL + '/administrator/pos_ibi_commandes/add_save',
