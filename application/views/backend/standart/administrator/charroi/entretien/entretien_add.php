                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="date" name="DATE_ENTRETIEN" id="DATE_ENTRETIEN" class="form-control" value="<?= set_value('DATE_ENTRETIEN') ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                   <div class="form-group">
                                      <label for="GRAISSAGE_ENTRETIEN" class=" control-label">Graissage
                                          ...
                                          <input type="text" name="GRAISSAGE_ENTRETIEN" id="GRAISSAGE_ENTRETIEN" class="form-control" placeholder="Graissage" value="<?= set_value('GRAISSAGE_ENTRETIEN'); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="number" class="form-control" name="KM_ENTRETIEN" id="KM_CONS_CAR" placeholder="Kilométrage" value="<?= set_value('KM_ENTRETIEN'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" placeholder="Huile Boite" name="HUILE_B_ENTRETIEN" class="form-control" value="<?= set_value('HUILE_B_ENTRETIEN') ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="HUILE_P_ENTRETIEN" placeholder="Huile Pont" class="form-control" value="<?= set_value('HUILE_P_ENTRETIEN') ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="HUILE_F_ENTRETIEN" id="HUILE_F_ENTRETIEN" placeholder="Consommation" value="<?= set_value('HUILE_F_ENTRETIEN'); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="FILTRE_C_ENTRETIEN" placeholder="Filtre à carburant" class="form-control" value="<?= set_value('FILTRE_C_ENTRETIEN') ?>">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="FILTRE_H_ENTRETIEN" id="FILTRE_H_ENTRETIEN" placeholder="Filtre à huile" value="<?= set_value('FILTRE_H_ENTRETIEN'); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="FILTRE_A_ENTRETIEN" placeholder="Filtre à air" class="form-control" id="FILTRE_A_ENTRETIEN" value="<?= set_value('FILTRE_A_ENTRETIEN') ?>">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="PROCH_VID_KMS_ENTRETIEN" placeholder="Prochaine vidange à Kms" class="form-control" id="PROCH_VID_KMS_ENTRETIEN" value="<?= set_value('PROCH_VID_KMS_ENTRETIEN') ?>">
                                    </div>
                                  </div>
                                </div>
                              </div>
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + '/administrator/entretien/add_save/<?=$this->uri->segment(4);?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
