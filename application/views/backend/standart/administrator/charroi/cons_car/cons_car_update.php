                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                   <div class="form-group">
                                      ...
                                      <i class="required">*</i>
                                          ...
                                          <input type="text" name="CHAUFFEUR_CONS_CAR" id="CHAUFFEUR_CONS_CAR" class="form-control" placeholder="Nom du Chauffeur" value="<?= set_value('CHAUFFEUR_CONS_CAR', $info_cons_car['CHAUFFEUR_CONS_CAR']); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                      <label for="REF_VOITURE_CONS_CAR" class="control-label">Plaque de la voiture<i class="required">*</i> 
                                          ...
                                          <?php foreach (db_get_all_data('pos_voitures') as $row): ?>
                                            <option <?=  $row->ID_VOITURE ==  $info_cons_car['REF_VOITURE_CONS_CAR'] ? 'selected' : ''; ?>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="date" name="DATE_CONS_CAR" id="DATE_CONS_CAR" class="form-control" value="<?= set_value('DATE_CONS_CAR', $info_cons_car['DATE_CONS_CAR']) ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="number" class="form-control" name="KM_CONS_CAR" id="KM_CONS_CAR" placeholder="Kilométrage" value="<?= set_value('KM_CONS_CAR', $info_cons_car['KM_CONS_CAR']); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="number" placeholder="Litres" name="LITRES_CONS_CAR" class="form-control" value="<?= set_value('LITRES_CONS_CAR', $info_cons_car['LITRES_CONS_CAR']) ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="DE_CONS_CAR" class="form-control" value="<?= set_value('DE_CONS_CAR', $info_cons_car['DE_CONS_CAR']) ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control" name="CONSOMMATION_CONS_CAR" id="CONSOMMATION_CONS_CAR" placeholder="Consommation" value="<?= set_value('CONSOMMATION_CONS_CAR', $info_cons_car['CONSOMMATION_CONS_CAR']); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="OBSERVATIONS_CONS_CAR" placeholder="Observations" class="form-control" value="<?= set_value('OBSERVATIONS_CONS_CAR', $info_cons_car['OBSERVATIONS_CONS_CAR']) ?>">
                                    </div>
                                  </div>
                                </div>
                              </div>
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + '/administrator/consommation_carburant/edit_save/<?=$this->uri->segment(4);?>/<?=$this->uri->segment(5)?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
