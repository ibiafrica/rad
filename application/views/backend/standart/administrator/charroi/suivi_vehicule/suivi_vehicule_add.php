                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                   <div class="form-group">
                                      ...
                                      <i class="required">*</i>
                                          ...
                                          <input type="text" name="CHAUFFEUR_SUIVI" id="CHAUFFEUR_SUIVI" class="form-control" placeholder="Nom du Chauffeur" value="<?= set_value('CHAUFFEUR_SUIVI'); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                      <label for="PLAQUE_VOITURE_SUIVI" class="control-label">Plaque de la voiture<i class="required">*</i> 
                                      </label>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="date" name="DATE_SUIVI" id="DATE_SUIVI" class="form-control" value="<?= set_value('DATE_SUIVI') ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="number" class="form-control" name="NBRE_PASSAGERS_SUIVI" id="NBRE_PASSAGERS_SUIVI" placeholder="Nombres de passagers" value="<?= set_value('NBRE_PASSAGERS_SUIVI'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="time" name="START_TIME_SUIVI" class="form-control" value="<?= set_value('START_TIME_SUIVI') ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="time" name="END_TIME_SUIVI" class="form-control" value="<?= set_value('END_TIME_SUIVI') ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control" name="KMS_DEPART_SUIVI" id="KMS_DEPART_SUIVI" placeholder="Kms départ" value="<?= set_value('KMS_DEPART_SUIVI'); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="number" class="form-control" name="KMS_RETOUR_SUIVI" id="KMS_RETOUR_SUIVI" placeholder="Kms retour" value="<?= set_value('KMS_RETOUR_SUIVI'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="OBSERVATION_SUIVI" class="form-control" value="<?= set_value('OBSERVATION_SUIVI') ?>">
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group ">
                                  ...
                                  <div class="col-sm-8">
                                      <textarea class="form-control" id="MOTIF_SUIVI" rows="3" name="MOTIF_SUIVI"></textarea>
                                      <small class="info help-block">
                                      </small>
                                  </div>
                                </div>
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + '/administrator/suivi_vehicule/add_save/<?=$this->uri->segment(4);?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
