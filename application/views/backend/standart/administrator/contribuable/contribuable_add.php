...
<section class="content-header">
    <h1>
        Contribuable        <small><?= cclang('new', ['Contribuable']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                                    ...
                                    <div class="card" style="width: 100%;">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tp_name" id="tp_name" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tp_TIN" id="tp_TIN" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_postal_number">Code Postal</label>
                                                <input type="text" name="tp_postal_number" id="tp_postal_number" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_phone_number">Telephone</label>
                                                <input type="text" name="tp_phone_number" id="tp_phone_number" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_trade_number">Numero du registre</label>
                                                <input type="text" name="tp_trade_number" id="tp_trade_number" class="form-control" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="card" style="width: 100%;">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tp_address_province" id="tp_address_province" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_address_commune">Commune</label>
                                                <input type="text" name="tp_address_commune" id="tp_address_commune" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_address_quartier">Quartier</label>
                                                <input type="text" name="tp_address_quartier" id="tp_address_quartier" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_address_avenue">Avenue</label>
                                                <input type="text" name="tp_address_avenue" id="tp_address_avenue" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_address_rue">Rue</label>
                                                <input type="text" name="tp_address_rue" id="tp_address_rue" class="form-control" value="" />
                                            </div>
                                            <div class="form-group">
                                                <label for="tp_address_number">Numero de la maison</label>
                                                <input type="text" name="tp_address_number" id="tp_address_number" class="form-control" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <input type="text" name="tp_fiscal_center" id="tp_fiscal_center" class="form-control" value="" />
                                                </div>
                                                <div class="form-group">
                                                <label for="tp_activity_sector">Secteur d'activite</label>
                                                <input type="text" name="tp_activity_sector" id="tp_activity_sector" class="form-control" value="" />
                                                </div>
                                                <div class="form-group">
                                                <label for="tp_legal_form">Forme Juridique</label>
                                                <input type="text" name="tp_legal_form" id="tp_legal_form" class="form-control" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/contribuable/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
