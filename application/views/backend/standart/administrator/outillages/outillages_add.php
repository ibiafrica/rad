...
<section class="content-header">
    <h1>
        Ajouter un nouveau outillage        <small></small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                         ...
                         <div id="identification" class="tab-pane fade in active">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="DESIGN_OUTILLAGE" id="DESIGN_OUTILLAGE"  value="<?= set_value('DESIGN_OUTILLAGE'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="SKU_OUTILLAGE" id="SKU_OUTILLAGE" value="<?= set_value('SKU_OUTILLAGE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                    ...
                    <div id="prix" class="tab-pane fade">
                        <p>  
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="PRIX_DE_VENTE_OUTILLAGE" id="PRIX_DE_VENTE_OUTILLAGE" placeholder="Prix De Vente" value="<?= set_value('PRIX_DE_VENTE_OUTILLAGE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="PRIX_DACHAT_OUTILLAGE" id="PRIX_DACHAT_OUTILLAGE" placeholder="Prix D Achat" value="<?= set_value('PRIX_DACHAT_OUTILLAGE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                                                ...
                                                <div class="form-group ">
                            <label for="QUANTITE_RESTANTE_OUTILLAGE" class="col-sm-2 control-label">Quantite 
                            </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="QUANTITE_RESTANTE_OUTILLAGE" id="QUANTITE_RESTANTE_OUTILLAGE" placeholder="Quantite" value="<?= set_value('QUANTITE_RESTANTE_OUTILLAGE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                    ...
                    <div id="caracteristiques" class="tab-pane fade">
                        <p>  
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="POIDS_OUTILLAGE" id="POIDS_OUTILLAGE" placeholder="Unite" value="<?= set_value('POIDS_OUTILLAGE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="MINIMUM_QUANTITY_OUTILLAGE" id="MINIMUM_QUANTITY_OUTILLAGE" placeholder="Minimum quantite" value="<?= set_value('MINIMUM_QUANTITY_OUTILLAGE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="DESCRIPTION_OUTILLAGE" name="DESCRIPTION_OUTILLAGE" rows="5" cols="80"><?= set_value('DESCRIPTION_OUTILLAGE'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="outillages_APERCU_OUTILLAGE_name" id="outillages_APERCU_OUTILLAGE_name" type="hidden" value="<?= set_value('outillages_APERCU_OUTILLAGE_name', $outillages->APERCU_OUTILLAGE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/outillages/add_save/<?=$this->uri->segment(4);?>',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
