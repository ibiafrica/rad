                        ...
                        <div class="col-sm-10">
                          ...
                          <div class="form-group ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" class="form-control" name="titre" placeholder="Entrer un titre pour votre outillage" value="">
              ...
              <div class="row">
                ...
                <div class="box-body no-padding">
                      ...
                      <div class="footer">
                          ...
                          <a class="btn btn-flat -default btn_action" id="btn_cancel" title="back (Ctrl+x)" href="<?= site_url('administrator/outillages/outillages_exit_list/'.$this->uri->segment(4).''); ?>"><i class="fa fa-undo" ></i>Annuler </a>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_save').click(function(){
        ...
        $.ajax({
            url: BASE_URL + '/administrator/outillages/outillages_exit_add_save/<?=$this->uri->segment(4)?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
  ...
  function search(data){
        ...
        $("#list").attr("hidden", 'true');
          let row = `
            <tr id="${ii}">
              ...
              <td><input type="hidden" class="form-control" name="name[]" value="${name}">${name}
              </td>
              <td><input type="text" class="form-control" name="demandeur[]"></td>
   ...
   $(document).ready(function(){
    ...
    $('input#myInput').keyup( function() {
         ...
         $.ajax({
                method: 'post',
                url: BASE_URL + '/administrator/outillages/search_produits/<?=$this->uri->segment(4)?>',
                dataType: "JSON",
                data: {
                ...
                success: function(data) {
                  ...
                  <li style="cursor: pointer;">
                    <a class="articleOption" id="${data[i].CODEBAR_OUTILLAGE}" unit="${data[i].POIDS_OUTILLAGE}" nameOutil="${data[i].DESIGN_OUTILLAGE}" quantRest="${data[i].QUANTITE_RESTANTE_OUTILLAGE}">${data[i].DESIGN_OUTILLAGE} : ${data[i].CODEBAR_OUTILLAGE}
                    </a>
                  </li>`;
                  }
                  $('#myUL').html('');
