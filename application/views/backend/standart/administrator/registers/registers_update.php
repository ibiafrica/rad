            ...
            <div class="box box-warning">
                <div class="box-body ">
                 ...
                 <div class="box box-widget widget-user-2">
                  ...
                  <?= form_open(base_url('administrator/registers/edit_save/'.$this->uri->segment(4).'/'.$this->uri->segment(5)), [
                      'name'    => 'form_registers', 
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        ...
                        <?php is_allowed('registers_tva_check', function() use ($commandes){?>
                        <div class="col-sm-4">
            ...
            <div class="form-group">
              <div class="box-header">
                  <div style="display: block; position: relative;">
                    <input type="text" id="myInput" class="search-input form-control input-lg" placeholder="Rechercher le nom du produit ou codebarre(3 caractères minimum)">
                ...
                <div class="box-body no-padding">
                  ...
                  <?php 
                    ...
                    foreach ($getposProduit as $getgetposProduits) {
                      ...
                      $tvaPrice = $getgetposProduits['PRIX_TOTAL_COMMAND_PROD'] * 0.18;
                      $tvacPrice = $getgetposProduits['PRIX_TOTAL_COMMAND_PROD'] * 1.18;
                      ...
                      if($getgetposProduits['DISCOUNT_TYPE_COMMAND_PROD'] == 'percentage'){
                        ...
                        <tr id="<?=$i?>">
                          ...
                          <td class="tvaPrice_input"><?=$tvaPrice?></td>
                          <td class="tvacPrice_input"><?=$tvacPrice?></td>
...
<script type="text/javascript">
  ...
  function search(data){
    ...
    if(initial < 0.1){
      ...
      $(data).closest('tr').find('td.tvaPrice_input').text((price * 1)*1.18);
    ...
    //   $(data).closest('tr').find('td.total').text(price * 1);
      ...
      $(data).closest('tr').find('td.tvaPrice_input').text((price * initial)*1.18);
    }
  ...
  $(document).ready(function(){
    ...
    $('.delete').on('click', function () {
      ...
      $.ajax({
            method: "post",
            url: BASE_URL + '/administrator/registers/delete_produit_cart/<?=$this->uri->segment(4)?>/<?=$this->uri->segment(5)?>',
            dataType: "JSON",
            data: {
              "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>",
              ref_code_produit:ref_code_produit,code_command,code_command
              },
            success: function (data) {
