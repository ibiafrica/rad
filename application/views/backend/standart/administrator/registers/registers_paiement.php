			...
			<div class="bootbox-body">
				...
				<div class="row" style="border-top:solid 1px #EEE;">
					<div class="col-lg-2 col-md-2 col-sm-2" style="padding:0px;margin:0px;"><div class="list-group">
						...
						<?php if($type_commandes == 'complete' or $type_commandes == 'avance'){
							?>
								...
								<tbody>
                                    ...
                                    $remisetype = $getCommande['DISCOUNT_TYPE_COMMAND_PROD'];
										if($remisetype == 'percentage'){
											$remise = round($getCommande['DISCOUNT_PERCENT_COMMAND_PROD'] / $getCommande['QUANTITE_COMMAND_PROD']);
										}else{
											$remise = round($getCommande['DISCOUNT_AMOUNT_COMMAND_PROD'] / $getCommande['QUANTITE_COMMAND_PROD']);
										}
								        ...
								        $article = $this->model_registers->getOne('pos_store_'.$this->uri->segment(4).'_ibi_articles', array('CODEBAR_ARTICLE'=>$getCommande['REF_PRODUCT_CODEBAR_COMMAND_PROD']));
										 ...
										 $quantRestSt = isset($article['QUANTITE_RESTANTE_ARTICLE']) ? $article['QUANTITE_RESTANTE_ARTICLE'] : 0;
										 $price = $getCommande['PRIX_COMMAND_PROD'];
										 $prixtva = ($getCommande['PRIX_COMMAND_PROD']-$remise)*0.18;
										 $prixtva = round($prixtva);
										 $prixtotal = ($getCommande['PRIX_COMMAND_PROD']-$remise)+$prixtva;
