...
<section class="content-header">
    <h1>
        Pos Store 3 Ibi Article Stock Semi Fini        <small><?= cclang('new', ['Pos Store 3 Ibi Article Stock Semi Fini']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pos Store 3 Ibi Article Stock Semi Fini']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="REF_RAYON_ARTICLE" id="REF_RAYON_ARTICLE" placeholder="REF RAYON ARTICLE" value="<?= set_value('REF_RAYON_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="REF_SHIPPING_ARTICLE" id="REF_SHIPPING_ARTICLE" placeholder="REF SHIPPING ARTICLE" value="<?= set_value('REF_SHIPPING_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="REF_PROVIDER_ARTICLE" id="REF_PROVIDER_ARTICLE" placeholder="REF PROVIDER ARTICLE" value="<?= set_value('REF_PROVIDER_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="REF_TAXE_ARTICLE" id="REF_TAXE_ARTICLE" placeholder="REF TAXE ARTICLE" value="<?= set_value('REF_TAXE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="SKU_ARTICLE" id="SKU_ARTICLE" placeholder="SKU ARTICLE" value="<?= set_value('SKU_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="QUANTITE_RESTANTE_ARTICLE" id="QUANTITE_RESTANTE_ARTICLE" placeholder="QUANTITE RESTANTE ARTICLE" value="<?= set_value('QUANTITE_RESTANTE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="QUANTITE_VENDU_ARTICLE" id="QUANTITE_VENDU_ARTICLE" placeholder="QUANTITE VENDU ARTICLE" value="<?= set_value('QUANTITE_VENDU_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="DEFECTUEUX_ARTICLE" id="DEFECTUEUX_ARTICLE" placeholder="DEFECTUEUX ARTICLE" value="<?= set_value('DEFECTUEUX_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="FRAIS_ACCESSOIRE_ARTICLE" id="FRAIS_ACCESSOIRE_ARTICLE" placeholder="FRAIS ACCESSOIRE ARTICLE" value="<?= set_value('FRAIS_ACCESSOIRE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="COUT_DACHAT_ARTICLE" id="COUT_DACHAT_ARTICLE" placeholder="COUT DACHAT ARTICLE" value="<?= set_value('COUT_DACHAT_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="TAUX_DE_MARGE_ARTICLE" id="TAUX_DE_MARGE_ARTICLE" placeholder="TAUX DE MARGE ARTICLE" value="<?= set_value('TAUX_DE_MARGE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="PRIX_DE_VENTE_TTC_ARTICLE" id="PRIX_DE_VENTE_TTC_ARTICLE" placeholder="PRIX DE VENTE TTC ARTICLE" value="<?= set_value('PRIX_DE_VENTE_TTC_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="SHADOW_PRICE_ARTICLE" id="SHADOW_PRICE_ARTICLE" placeholder="SHADOW PRICE ARTICLE" value="<?= set_value('SHADOW_PRICE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="TAILLE_ARTICLE" id="TAILLE_ARTICLE" placeholder="TAILLE ARTICLE" value="<?= set_value('TAILLE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="POIDS_ARTICLE" id="POIDS_ARTICLE" placeholder="POIDS ARTICLE" value="<?= set_value('POIDS_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="COULEUR_ARTICLE" id="COULEUR_ARTICLE" placeholder="COULEUR ARTICLE" value="<?= set_value('COULEUR_ARTICLE'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="HAUTEUR_ARTICLE" id="HAUTEUR_ARTICLE" placeholder="HAUTEUR ARTICLE" value="<?= set_value('HAUTEUR_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="LARGEUR_ARTICLE" id="LARGEUR_ARTICLE" placeholder="LARGEUR ARTICLE" value="<?= set_value('LARGEUR_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="APERCU_ARTICLE" id="APERCU_ARTICLE" placeholder="APERCU ARTICLE" value="<?= set_value('APERCU_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="CODEBAR_ARTICLE" id="CODEBAR_ARTICLE" placeholder="CODEBAR ARTICLE" value="<?= set_value('CODEBAR_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="DATE_CREATION_ARTICLE"  id="DATE_CREATION_ARTICLE">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="DATE_MOD_ARTICLE"  id="DATE_MOD_ARTICLE">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="TYPE_ARTICLE" id="TYPE_ARTICLE" placeholder="TYPE ARTICLE" value="<?= set_value('TYPE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="STATUS_ARTICLE" id="STATUS_ARTICLE" placeholder="STATUS ARTICLE" value="<?= set_value('STATUS_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="STOCK_ENABLED_ARTICLE" id="STOCK_ENABLED_ARTICLE" placeholder="STOCK ENABLED ARTICLE" value="<?= set_value('STOCK_ENABLED_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="AUTO_BARCODE_ARTICLE" id="AUTO_BARCODE_ARTICLE" placeholder="AUTO BARCODE ARTICLE" value="<?= set_value('AUTO_BARCODE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="BARCODE_TYPE_ARTICLE" id="BARCODE_TYPE_ARTICLE" placeholder="BARCODE TYPE ARTICLE" value="<?= set_value('BARCODE_TYPE_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="USE_VARIATION_ARTICLE" id="USE_VARIATION_ARTICLE" placeholder="USE VARIATION ARTICLE" value="<?= set_value('USE_VARIATION_ARTICLE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pos_store_3_ibi_article_stock_semi_fini/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
