<?php
                    ...
                    $this->db->select('NUMERO_FICHE');
                    $this->db->from('pos_store_2_ibi_fiche_travail');
                    $this->db->where('ID_FICHE',$this->uri->segment(4));
                   // $this->db->limit('1');
                    $query = $this->db->get();
              ...
              foreach ($query->result() as $value) {
                     $numero_fact = $value->NUMERO_FICHE;
                 }
               ...
               // $store = $this->uri->segment(3);
                //$urisegment='store_'.$store;
                    ...
                    // if($_GET['type']=='is_commande'){
                        ...
                        $comms = $this->db->query("SELECT * from pos_store_2_ibi_fiche_travail WHERE ID_FICHE='".$ur."'");

                    foreach ($comms->result() as $comm) {
                        
                        //$cod = $comm->DEVIS_CODE;
                        $nama = $comm->TITRE_FICHE;
                        $REF_CLIENT = $comm->REF_CLIENT_FICHE;
                        $DATE_CREATION = date('d/m/Y',strtotime($comm->DATE_CREATION_FICHE));
                    }
                        $commandprods = $this->db->query("SELECT * FROM pos_store_2_ibi_devis_produits WHERE ID_FICHE_DEVIS_PRO='".$ur."'");

                    /*}elseif($_GET['type']=='is_gamme'){
                        
                        $comms = $this->db->query("SELECT * from pos5_".$urisegment."_ibi_devis_fiche_travail WHERE ID='".$ur."'");

                    foreach ($comms->result() as $comm) {
                        
                        $cod = $comm->DEVIS_CODE;
                        $nama = $comm->TITRE;
                        $REF_CLIENT = $comm->REF_CLIENT;
                        $DATE_CREATION = date('d/m/Y',strtotime($comm->DATE_CREATION));
                    }

                        $commandprods = $this->db->query("SELECT * FROM pos5_".$urisegment."_ibi_devis_recettes WHERE REF_RECETTE_CODE='".$cod."'");
                    }else{
                        show_404();
                    }*/


                    $cl = $this->db->query("SELECT * FROM pos_ibi_clients WHERE ID_CLIENT='".$REF_CLIENT."'");

                    foreach ($cl->result() as $cl) {
                        
                        $izina = $cl->NOM_CLIENT.' '.$cl->PRENOM_CLIENT;
                    }
        // foreach ($commandprod as $commandprod1) {
        //            $x=$commandprod1->PRIX;
        //            $y=$commandprod1->QUANTITE;
        //            $somme=$x*$y;
        //        }
                ?>
<br><br>
        ...
        <div id="container">
              ...
              <section id="titre_ax">
                ...
                <section id="memo">
                    <div class="logo infos1" alt="logo">
                        <img src="http://gts.ibi-africa.com/quotation/logo_GTS_Red.png" width="150px" style="padding-top: -10px;"  data-logo="" />
                    </div>
                    ...
                    <div class="company-info">
                        ...
                        <table class="infos2">
                          ...
                          <tr style="height: 10px;">
                            <td style="font-size: 10px;text-align: left;">Date de Bon de Commande </td><td style="font-size: 10px;text-align: center;"> : <?php echo $DATE_CREATION; ?></td>
                          </tr>
                          <tr style="height: 10px;">
                            <td style="font-size: 10px;">Date de fin de Travail </td><td style="font-size: 10px;">: <input type="text" class="" name=""></td>
                          </tr>
                          <tr style="height: 10px;">
                            <td style="font-size: 10px;">Date de Livraison </td><td style="font-size: 10px;">: <input type="text" class="" name=""></td>
                          </tr>
                        </table>
           ...
           <!--  <div class="page-footer">
                <table style="margin:auto; width: 90%; border:0px solid;">
                    <tr>
                        <td><img src="http://production.ibi-africa.com/quotation/public/img/pictograms in line BLACK&WHITE.jpg" style="width: 100%; margin-left:-50px;"></td> -->
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="page">
                                <section id="items1">
                                   <div style="font-size: 15px;"><h1><b><u>Client : <?php echo $izina; ?></u></b></h1><br/></div>
                                ...
                                <section id="items">
                                    <div style="font-size: 15px;"><h1><b><u>Description : <?php echo $nama; ?></u></b></h1><br/></div>
                                    <table cellpadding="0" cellspacing="0">
                                            ...
                                            ?>
                                                      ...
                                                      <tr>
                                                        <td><?php echo ($commandprod->REF_PRODUCT_CODEBAR_DEVIS_PROD) ?></td>
                                                        <td><?php echo ($commandprod->NAME_DEVIS_PROD) ?></td>
                                                        <td><?php echo ($commandprod->QUANTITE_DEVIS_PROD) ?></td>
                                                        <td><?php echo ($commandprod->UNIT_DEVIS_PROD) ?></td>
                                                        <td><?php echo ($commandprod->QUANTITE_ADD_DEVIS_PROD) ?></td>
                                                        <td><?php echo ($commandprod->UNIT_DEVIS_PROD) ?></td>
                                                      </tr> 
