                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/facture_assurance/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" class="form-control" name="NUMERO_FACTURE_ASSURANCE" id="NUMERO_FACTURE_ASSURANCE" placeholder="Numéro" value="<?= set_value('NUMERO_FACTURE_ASSURANCE', $facture_assurance->NUMERO_FACTURE_ASSURANCE); ?>">
