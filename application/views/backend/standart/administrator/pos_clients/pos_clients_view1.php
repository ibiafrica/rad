      ...
      <!-- <hr> -->
        <br>
                  ...
                  <div class="form-horizontal" name="form_pos_clients" id="form_pos_clients" >
                     ...
                     <!--        <div class="form-group ">
                                <label for="content" class="col-sm-3 control-label">Type Discount </label>

                                <div class="col-sm-8">
                                   <?= _ent($pos_clients->TYPE_DISCOUNT); ?>
                                </div>
                            </div> -->
                                                 
                      <!--       <div class="form-group ">
                                <label for="content" class="col-sm-3 control-label">Discount </label>

                                <div class="col-sm-8">
                                   <?= _ent($pos_clients->DISCOUNT); ?>
                                </div>
                            </div> -->
                          <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-8">
                                   <?php echo $this->db->query("SELECT full_name FROM aauth_users WHERE id = ".$pos_clients->CREATED_BY_CLIENT." ")->row_array()['full_name']; ?>
                                </div>
                            </div>
                   ...
                   $get_cmd = $this->db->query("SELECT * FROM pos_ibi_commandes_produits  WHERE  pos_IBI_COMMANDES_ID = ".$facture->ID_pos_IBI_COMMANDES." ")->result();
                    ...
                    $sommation=0;
                       foreach($get_cmd as $paie){
                          $sommation=$paie->PRIX_TOTAL*$paie->QUANTITE;
                         $total+=$sommation;
                       }
                    ?>
                      <tr>
                                ...
                                <?php 
                                  foreach ($get_cmd as $cmd): ?>
                                    <tr>
                                      ...
                                      <td> <?php echo number_format($cmd->PRIX_TOTAL); ?></td>
                                      <td> <?php 
