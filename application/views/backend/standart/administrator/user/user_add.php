            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <?= form_open('', [
                    ...
                    <div class="form-group ">
                        <label for="pin" class="col-sm-2 control-label">Code pin <i class="required">*</i></label>

                        <div class="col-sm-8">
                          <div class="input-group col-md-12">
                          <input type="text" class="form-control pin" name="pin" id="pin" placeholder="Code pin" value="<?= set_value('pin'); ?>">
                            ...
                            <div class="col-sm-8">
                                <?php foreach (db_get_all_data('pos_ibi_stores',array('DELETE_BY_STORE'=>0)) as $row) : ?>
                                    <div class="col-md-3  padding-left-0">
                                        <label>
                                            <input type="checkbox" class="flat-red" name="boutique[]" value="<?= $row->ID_STORE ?>"> <?= $row->NAME_STORE; ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
