                  ...
                  <?= form_open(base_url('administrator/user/edit_save/'.$this->uri->segment(4)), [
                   ...
                   <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen-select" name="group[]" id="group" multiple placeholder="Select groups">
                            <?php foreach ($this->model_rm->isAdmin() ? db_get_all_data('aauth_groups') : db_get_all_data('aauth_groups',array('id'=>29))  as $row): ?>
                    ...
                    <div class="form-group  wrapper-options-crud">
                            <label for="boutique" class="col-sm-2 control-label">Boutique
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                    <?php foreach (db_get_all_data('pos_ibi_stores',array('DELETE_BY_STORE'=>0)) as $row): ?>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input <?=  in_array($row->ID_STORE, explode(',', $user->boutique)) ? 'checked' : ''; ?> type="checkbox" class="flat-red" name="boutique[]" value="<?= $row->ID_STORE ?>"> <?= $row->NAME_STORE; ?>
                                    </label>
                                    </div>
                                    <?php endforeach; ?>  
                    ...
                    <div class="form-group ">
                        <label for="pin" class="col-sm-2 control-label">Code pin</label>

                        <div class="col-sm-6">
                          <div class="input-group col-md-8">
                          <input type="text" class="form-control pin" name="pin" id="pin" placeholder="Code pin" value="<?= set_value('pin',$user->pin_code); ?>">
                            
                          </div>
                           <small class="info help-block">
                             The password character must 4 or more.
                          </small>
                        </div>
                    </div>
