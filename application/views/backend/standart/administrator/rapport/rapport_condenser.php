...
<section class="content-header">
    <h1>
        Rapports condenser<small> </small>
    </h1>
    <ol class="breadcrumb">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-lg-3 col-md-4 col-sm-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control dateTimePickers" name="date_depart" value="<?= isset($start) ? $start : date("Y-m-d H:i:s"); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-4 col-sm-4">
                                                <div class="input-group">
                                                    <span class="input-group-addon">End</span>
                                                    <input type="text" class="form-control dateTimePickers" name="date_fin" value="<?= isset($end) ? $end : date("Y-m-d H:i:s"); ?>">
                                                </div>
                                            </div>
