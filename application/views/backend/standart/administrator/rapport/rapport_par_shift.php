...
<section class="content-header">
    <h1>
        Liste <?= isset($is_shift) ? "par shifts" : "shift"; ?><small>
        </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="">Shift</a>
        </li>
            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <form class="form-horizontal" name="form_hospital_ibi_articles" id="form_hospital_ibi_articles" action="<?= base_url('administrator/rapports/get_list_shift'); ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="date_start" class="form-control dateTimePickers" value="<?= $dateStart; ?>">
                                            </div>
                                        </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-info btn-default btn-xs btn-flat" href="<?php echo base_url('administrator/rapports/recette_journaliere_shift/' . $k->ID_SHIFT) ?>">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
