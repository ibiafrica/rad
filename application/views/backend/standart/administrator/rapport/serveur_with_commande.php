                                ...
                                <div class="col-sm-12 col-md-12" style="">
                                    ...
                                    <div class="col-sm-2" style="border: 0px solid;">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('rapports/commande_serveurs/' . $this->uri->segment(3) . ' '); ?>" title="Réinitialiser la recherche">
