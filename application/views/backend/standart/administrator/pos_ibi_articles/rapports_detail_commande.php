...
<section class="content-header">
   <h1>
      Rapports detail Commandes      <small> </small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class=""><a  href="<?= site_url('administrator/articles'); ?>">Rap.Commandes</a></li>
         ...
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <!--          <div class="box-header with-border">mouvement de stock</div> -->
                ...
                <tr>
                  <th class="text-center" width=""> CODE_BAR</th>
                  <th class="text-center" width="">Désignation </th>
                  <th class="text-center">Quantité</th>
                  <th class="text-center">Prix unitaire</th>
                  <th class="text-center"> Prix Total</th>
                  <th class="text-center">BTQ Provenance</th>
                  <th class="text-center">Date creer</th>
                  <th class="text-center">Actions</th>
                          ...
                          <tbody>
                             <?php foreach ($PRODUCT_COMMAND as $VAL) { ?>
                               <tr>
                                 <td class="text-center">  <?= $VAL->REF_PRODUCT_CODEBAR;?></td>
                                 <td class="text-center"><?= $VAL->NAME?> </td>
                                 <td class="text-center"> <?= $VAL->QUANTITE?></td>
                                 <td class="text-center"><?= $VAL->PRIX?> </td>
                                 <td class="text-center"> <?= $VAL->PRIX_TOTAL?></td>
                                 <td class="text-center"> <?= $VAL->pos_IBI_COMMANDES_ID?></td>
                                 <td class="text-center"> <?= $VAL->DATE_CREATION_pos_IBI_COMMANDES_PRODUITS?> </td>
                                </tr>
                             <?php }?>
                          </tbody>
                        ...
                        <tfoot>
                          <a href="<?php BASE_URL('rapports/mouvement_de_stock')?>" type = "button" class="btn btn-default"> <i class="fa fa-arrow-left" aria-hidden="true"></i> </a>
                        </tfoot>
