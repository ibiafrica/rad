            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <form class="form-horizontal" name="form_hospital_ibi_articles" id="form_hospital_ibi_articles" action="<?= base_url('articles/' . $this->uri->segment(2) . '/historique/' . $this->uri->segment(4) . ''); ?>">
                        ...
                        <i class="fa fa-search"></i>
                                ...
                                <div class="btn-group btn-group-md">
                                    <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/articles/historique/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . ''); ?>" title="<?= cclang('reset_filter'); ?>">
                                ...
                                <div class="box-body no-padding">
                                    <table class="table  table-striped" id="headerTable">
                                        ...
                                        <tbody>
                                            ...
                                            $ajustement= $this->db->query('SELECT AJUSTEMENT_NAME FROM pos_ibi_type_ajustement')->row();
                                            // foreach ($ajustement as $key) {
                                               
                                               $nom = $ajustement->AJUSTEMENT_NAME;
                                            // }
                                            ...
                                            foreach ($articles as $article) :
                                                ...
                                                $type_sf = '';
                                                 ...
                                                 if ($article->TYPE_SF == $nom) {
                                                   $type_sf = $nom;
                                                }

                                                else{
                                                    $type_sf=$article->TYPE_SF;
                                                }
                                                ...
                                                if ($article->TYPE_SF == 'transfert_out') {
                                                    $type_sf = 'Transfert envoyé';
                                                }
                                                if ($article->TYPE_SF == 'transfert_in') {
                                                    $type_sf = 'Transfert reçu';
                                                }
                                                if ($article->TYPE_SF == 'sale') {
                                                    $type_sf =  'Vente';
                                                }
                                                if ($article->TYPE_SF == 'inventory') {
                                                    $type_sf =  'Inventaire';
                                                }

                                                if ($article->TYPE_SF == 'stock_out_modify') {
                                                    $type_sf =  'Sortie modifier';
                                                }

                                                if ($article->TYPE_SF == 'sale_stock_in') {
                                                    $type_sf =  'Retour article vendu';
                                                }
                                                if ($article->TYPE_SF == 'inventory_excedent') {
                                                    $type_sf =  'Inventaire Retour';
                                                }
                                                if ($article->TYPE_SF == 'inventory_perte') {
                                                    $type_sf =  'Inventaire perte';
                                                }
