         ...
         <div class="box-body ">
           <div class="col-md-6">
             ...
             <div class="form-group champs">
               ...
               <select  id="designation" class="form-control" readonly="readonly"  data-placeholder="Categorie">
                   <option value="<?= $articles->ID_ARTICLE ?>"><?= $articles->DESIGN_ARTICLE; ?></option>
               </select>
             </div>
                         ...
                         <?php
                          ...
                          if ($product_list) {
                            ...
                            foreach ($product_list as $product) {
                              ...
                              $total_general += $product->PRIX_DACHAT_ARTICLE_DETAIL * $product->INGREDIENT_QUANTITY;
              ...
              <input style='border-radius:0px !important;width:70px' type=\"text\" name=\"quantity[]\" onkeyup=\"quantity_calculate('" . $product_id . "');\" onchange=\"quantity_calculate('" . $product_id . "');\" id=\"total_qntt_" . $product_id . "\" class=\"form-control text-right variant_ids_" . $product->ID_ARTICLE . "   available_quantity_" . $product_id . "\" value=" . $product->INGREDIENT_QUANTITY . " min=\"0\"  />
                    ...
                    <input type=\"hidden\" name=\"design[]\" value=" . $product->DESIGN_ARTICLE . ">
                      ...
                      <td nowrap>
                         ...
                         <td nowrap>
                <input style='border-radius:0px !important;width:70px;' class=\"total_price form-control text-right\" type=\"text\" name=\"total_price[]\" id=\"total_price_" . $product_id . "\" value='" . $product->PRIX_DACHAT_ARTICLE_DETAIL * $product->INGREDIENT_QUANTITY . "'  readonly=\"readonly\" style=\"width:70px\"/>
                          </td>
                       ...
                       <tr>
                         ...
                         <td colspan="3">
                           ...
                           <div class="input-group col-md-12">
                             ...
                             <?php
                              ?>
                             <input style="border-radius:0px !important;" type="text" value="<?php echo $total_general;  ?>" class="form-control text-right htva cout_prod" placeholder="0.00" name="prix" readonly="readonly" />
     ...
     if (designation == '' || categorie == '') {
       ...
       if (nature == 1 && qtes == 0) {
         ...
         if (cout == '' || cout == 0) {
           ...
           $.ajax({
             url: "<?php echo base_url('administrator/articles/modification_de_plats')  ?>",
             method: "POST",
             ...
             success: function(data) {
               ...
               toastr['success']('plat modifier avec success');
