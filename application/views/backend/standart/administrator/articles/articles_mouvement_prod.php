                    ...
                    <form name="form_mouvement" id="form_mouvement" action="<?= base_url('administrator/rapport/mouvement/'.$this->uri->segment(4).''); ?>">
                        <div class="row pull-center">
                            <div class="col-md-12">
                              ...
                              <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="text" class="form-control" name="produit_name" id="produit_name" value="<?=$produit_name?>" placeholder="Nom produit">
                              </div>
                              <div class="col-lg-2 col-md-2 col-sm-2">
                             ...
                             if(!isset($sortie)){
                              ...
                              ?>
                                <tr class="item"> 
                                   ...
                                   <td><?= round(_ent($entree['QUANTITE_SF'])); ?></td>
                                   <td><?= round(_ent($sortie['QUANTITE_SF'])); ?></td>
                                </tr>
                              <?php endforeach; ?>
