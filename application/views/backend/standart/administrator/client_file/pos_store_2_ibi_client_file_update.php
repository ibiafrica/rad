...
<section class="content-header">
    <h1>
        Pos Store 2 Ibi Client File        <small>Edit Pos Store 2 Ibi Client File</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Pos Store 2 Ibi Client File</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/pos_store_2_ibi_client_file/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="PROFORMA_ID_CLIENT_FILE" id="PROFORMA_ID_CLIENT_FILE" placeholder="PROFORMA ID CLIENT FILE" value="<?= set_value('PROFORMA_ID_CLIENT_FILE', $pos_store_2_ibi_client_file->PROFORMA_ID_CLIENT_FILE); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="REF_CLIENT_FILE" id="REF_CLIENT_FILE" placeholder="REF CLIENT FILE" value="<?= set_value('REF_CLIENT_FILE', $pos_store_2_ibi_client_file->REF_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="REF_PROFORMA_CODE_CLIENT_FILE" id="REF_PROFORMA_CODE_CLIENT_FILE" placeholder="REF PROFORMA CODE CLIENT FILE" value="<?= set_value('REF_PROFORMA_CODE_CLIENT_FILE', $pos_store_2_ibi_client_file->REF_PROFORMA_CODE_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="NUMBER_PURCHASE_CLIENT_FILE" id="NUMBER_PURCHASE_CLIENT_FILE" placeholder="NUMBER PURCHASE CLIENT FILE" value="<?= set_value('NUMBER_PURCHASE_CLIENT_FILE', $pos_store_2_ibi_client_file->NUMBER_PURCHASE_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="pos_store_2_ibi_client_file_FILE_PURCHASE_CLIENT_FILE_uuid" id="pos_store_2_ibi_client_file_FILE_PURCHASE_CLIENT_FILE_uuid" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_FILE_PURCHASE_CLIENT_FILE_uuid'); ?>">
                                <input class="data_file" name="pos_store_2_ibi_client_file_FILE_PURCHASE_CLIENT_FILE_name" id="pos_store_2_ibi_client_file_FILE_PURCHASE_CLIENT_FILE_name" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_FILE_PURCHASE_CLIENT_FILE_name', $pos_store_2_ibi_client_file->FILE_PURCHASE_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="pos_store_2_ibi_client_file_COMMISSIONING_CLIENT_FILE_uuid" id="pos_store_2_ibi_client_file_COMMISSIONING_CLIENT_FILE_uuid" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_COMMISSIONING_CLIENT_FILE_uuid'); ?>">
                                <input class="data_file" name="pos_store_2_ibi_client_file_COMMISSIONING_CLIENT_FILE_name" id="pos_store_2_ibi_client_file_COMMISSIONING_CLIENT_FILE_name" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_COMMISSIONING_CLIENT_FILE_name', $pos_store_2_ibi_client_file->COMMISSIONING_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="pos_store_2_ibi_client_file_CONTRAT_GARANTIE_CLIENT_FILE_uuid" id="pos_store_2_ibi_client_file_CONTRAT_GARANTIE_CLIENT_FILE_uuid" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_CONTRAT_GARANTIE_CLIENT_FILE_uuid'); ?>">
                                <input class="data_file" name="pos_store_2_ibi_client_file_CONTRAT_GARANTIE_CLIENT_FILE_name" id="pos_store_2_ibi_client_file_CONTRAT_GARANTIE_CLIENT_FILE_name" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_CONTRAT_GARANTIE_CLIENT_FILE_name', $pos_store_2_ibi_client_file->CONTRAT_GARANTIE_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="pos_store_2_ibi_client_file_CONTRAT_MAINTENANCE_CLIENT_FILE_uuid" id="pos_store_2_ibi_client_file_CONTRAT_MAINTENANCE_CLIENT_FILE_uuid" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_CONTRAT_MAINTENANCE_CLIENT_FILE_uuid'); ?>">
                                <input class="data_file" name="pos_store_2_ibi_client_file_CONTRAT_MAINTENANCE_CLIENT_FILE_name" id="pos_store_2_ibi_client_file_CONTRAT_MAINTENANCE_CLIENT_FILE_name" type="hidden" value="<?= set_value('pos_store_2_ibi_client_file_CONTRAT_MAINTENANCE_CLIENT_FILE_name', $pos_store_2_ibi_client_file->CONTRAT_MAINTENANCE_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="INVOICE_NUMBER_CLIENT_FILE" id="INVOICE_NUMBER_CLIENT_FILE" placeholder="INVOICE NUMBER CLIENT FILE" value="<?= set_value('INVOICE_NUMBER_CLIENT_FILE', $pos_store_2_ibi_client_file->INVOICE_NUMBER_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="OPERATING_STATUT" id="OPERATING_STATUT" placeholder="OPERATING STATUT" value="<?= set_value('OPERATING_STATUT', $pos_store_2_ibi_client_file->OPERATING_STATUT); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="APPROUVE_BY" id="APPROUVE_BY" placeholder="APPROUVE BY" value="<?= set_value('APPROUVE_BY', $pos_store_2_ibi_client_file->APPROUVE_BY); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="CLOSURE_BY_CLIENT_FILE" id="CLOSURE_BY_CLIENT_FILE" placeholder="CLOSURE BY CLIENT FILE" value="<?= set_value('CLOSURE_BY_CLIENT_FILE', $pos_store_2_ibi_client_file->CLOSURE_BY_CLIENT_FILE); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="AUTHOR" id="AUTHOR" placeholder="AUTHOR" value="<?= set_value('AUTHOR', $pos_store_2_ibi_client_file->AUTHOR); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_pos_store_2_ibi_client_file.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#pos_store_2_ibi_client_file_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#pos_store_2_ibi_client_file_FILE_PURCHASE_CLIENT_FILE_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/pos_store_2_ibi_client_file/get_FILE_PURCHASE_CLIENT_FILE_file/<?= $pos_store_2_ibi_client_file->ID_CLIENT_FILE; ?>',
      ...
      }); /*end FILE_PURCHASE_CLIENT_FILE galey*/
                            var params = {};
       params[csrf] = token;
       ...
       $('#pos_store_2_ibi_client_file_COMMISSIONING_CLIENT_FILE_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/pos_store_2_ibi_client_file/get_COMMISSIONING_CLIENT_FILE_file/<?= $pos_store_2_ibi_client_file->ID_CLIENT_FILE; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
      ...
      }); /*end COMMISSIONING_CLIENT_FILE galey*/
                            var params = {};
       params[csrf] = token;
       ...
       $('#pos_store_2_ibi_client_file_CONTRAT_GARANTIE_CLIENT_FILE_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/pos_store_2_ibi_client_file/get_CONTRAT_GARANTIE_CLIENT_FILE_file/<?= $pos_store_2_ibi_client_file->ID_CLIENT_FILE; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
      ...
      }); /*end CONTRAT_GARANTIE_CLIENT_FILE galey*/
                            var params = {};
       params[csrf] = token;
       ...
       $('#pos_store_2_ibi_client_file_CONTRAT_MAINTENANCE_CLIENT_FILE_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/pos_store_2_ibi_client_file/get_CONTRAT_MAINTENANCE_CLIENT_FILE_file/<?= $pos_store_2_ibi_client_file->ID_CLIENT_FILE; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
      ...
      }); /*end CONTRAT_MAINTENANCE_CLIENT_FILE galey*/
