...
<section class="content-header">
    <h1>
        Marge Prix        <small><?= cclang('new', ['Marge Prix']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Marge Prix']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="DESIGNATION" id="DESIGNATION" placeholder="DESIGNATION" value="<?= set_value('DESIGNATION'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="MARGE" id="MARGE" placeholder="MARGE" value="<?= set_value('MARGE'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" max="2" class="form-control" name="TYPE_MARGE" id="TYPE_MARGE" placeholder="TYPE MARGE" value="<?= set_value('TYPE_MARGE'); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/marge_prix/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
