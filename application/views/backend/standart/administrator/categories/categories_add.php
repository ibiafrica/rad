...
<section class="content-header">
    <h1>
        ...
        Ajouter la catégorie    <small></small>
    </h1>
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Nouvelle catégorie</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="NOM_CATEGORIE" id="NOM_CATEGORIE" placeholder="Nom de la catégorie" value="<?= set_value('NOM_CATEGORIE'); ?>">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="categories_THUMB_CATEGORIE_uuid" id="categories_THUMB_CATEGORIE_uuid" type="hidden" value="<?= set_value('categories_THUMB_CATEGORIE_uuid'); ?>">
                                <input class="data_file" name="categories_THUMB_CATEGORIE_name" id="categories_THUMB_CATEGORIE_name" type="hidden" value="<?= set_value('categories_THUMB_CATEGORIE_name'); ?>">
                                <small class="info help-block">
                                </small>
    ...
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          ...
          url: BASE_URL + '/administrator/categories/add_save/<?=$this->uri->segment(4)?>',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            ...
            var id_THUMB_CATEGORIE = $('#categories_THUMB_CATEGORIE_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_THUMB_CATEGORIE !== 'undefined') {
                    $('#categories_THUMB_CATEGORIE_galery').fineUploader('deleteFile', id_THUMB_CATEGORIE);
                }
