            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/pos_ibi_categories/edit_save/'.$this->uri->segment(4).'/'.$this->uri->segment(5)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="NOM_CATEGORIE" id="NOM_CATEGORIE" placeholder="Nom " value="<?= set_value('NOM_CATEGORIE', $pos_ibi_categories->NOM_CATEGORIE); ?>">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="PARENT_REF_ID_CATEGORIE" id="PARENT_REF_ID_CATEGORIE" data-placeholder="Select PARENT REF ID CATEGORIE" >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('famille') as $row): ?>
                                    <option <?=  $row->ID_FAMILLE ==  $pos_ibi_categories->PARENT_REF_ID_CATEGORIE ? 'selected' : ''; ?> value="<?= $row->ID_FAMILLE ?>"><?= $row->NOM_FAMILLE; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
