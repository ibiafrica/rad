...
<section class="content-header">
    <h1>
        Categories ingredient        <small>Nouveau </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a  href="<?= site_url('administrator/pos_ingredient_categories'); ?>">Categories ingredient</a></li>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pos_ingredient_categories/add_save/<?php echo $this->uri->segment(2); ?>',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
