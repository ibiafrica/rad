...
<section class="content-header">
    <h1>
        Flux Caisse        <small><?= cclang('new', ['Flux Caisse']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Flux Caisse']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="NOM_FLUX_CAISSE" id="NOM_FLUX_CAISSE" placeholder="Nom Flux Caisse" value="<?= set_value('NOM_FLUX_CAISSE'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="MONTANT_FLUX_CAISSE" id="MONTANT_FLUX_CAISSE" placeholder="Montant" value="<?= set_value('MONTANT_FLUX_CAISSE'); ?>">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="TYPE_FLUX_CAISSE" id="TYPE_FLUX_CAISSE" data-placeholder="Select TYPE FLUX CAISSE" >
                                    ...
                                    <option value="<?= $row->ID_ACTIVITE ?>"><?= $row->DESIGN_ACTIVITE; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="CATEGORIE_FLUX" id="CATEGORIE_FLUX" data-placeholder="Select CATEGORIE FLUX" >
                                    ...
                                    <option value="<?= $row->ID_CATEGORIE_DEPENSE ?>"><?= $row->NOM_CATEGORIE_DEPENSE; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <textarea id="DESCRIPTION_FLUX" name="DESCRIPTION_FLUX" rows="5" class="textarea"><?= set_value('DESCRIPTION_FLUX'); ?></textarea>
