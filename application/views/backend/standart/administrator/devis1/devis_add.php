...
<script type="text/javascript">
    ...
    $('.btn_save').click(function() {
      ...
      var description= $('.titre').val();

      var client = $("#client").children("option:selected").val();

      if (description == '') 
        {
          sweetAlert('Donner une description');
      ...
      {
        sweetAlert('Sélectionner un client');
...
/*   if(qty>quantRest){
  ...
  function search(data){
    ...
    $('.btn_saves').click(function() {
                ...
                var client = $("#client12").children("option:selected").val(); 

                var code_gamme = $("#code_gamme").children("option:selected").val();
                 ...
                 {
                  sweetAlert('Sélectionner une fiche');
                   // error += "<p>Entrer la description du devis...</p>";
                    return false;
      ...
      avoid_multi_click_btn('btn_saves', 25000);
