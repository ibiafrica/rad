...
href="<?= site_url('administrator/devis/'.$this->uri->segment(4)); ?>" class="btn btn-danger" id="cancel" title="Retour"><span class="glyphicon glyphicon-remove"></span></a>
<?php if($status==0){?>
      ...
      <div class="modal-body">
        <?php
              ...
              //$p='pos5_';
               ...
               $getProduit=$this->db->query('SELECT * FROM pos_store_'.$this->uri->segment(4).'_ibi_articles WHERE CODEBAR_ARTICLE not in (SELECT REF_PRODUCT_CODEBAR_DEVIS_PROD FROM pos_store_'.$this->uri->segment(4).'_ibi_devis_produits WHERE REF_DEVIS_CODE_DEVIS_PROD="'.$deviscode.'")');
