...
href="<?= site_url('administrator/devis/index/'.$this->uri->segment(4)); ?>" class="btn btn-danger" id="cancel" title="Retour"><span class="glyphicon glyphicon-remove"></span></a>
<?php if($status==0){?>
...
<button style="display: none" class="btn btn-flat btn-primary add_quantites_on_devis btn_action btn_save_back" id="btn_save" data-stype='back' title="Enregistrer et retourner à la liste">
