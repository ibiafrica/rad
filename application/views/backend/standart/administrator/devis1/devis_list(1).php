         ...
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="voir les devis en attentes" href="<?=  site_url('administrator/devis/devis_liste_attente/'.$this->uri->segment(4)); ?>"><i class="fa fa-list" ></i>&nbsp;&nbsp;Devis en attentes</a>
                     <?php }) ?>
                     </div>
                     ...
                     <h5 class="widget-user-desc">Liste des commandes approuvées  <i class="label bg-yellow"><?= $devis_counts; ?>  Elément<?php if($devis_counts > 1)echo 's'; ?></i></h5>
                  </div>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                   ...
                   <a  title="Créer un proforma" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal<?php echo $pos_store_2_ibi_devis->ID_DEVIS; ?>"><i class="fa fa-plus"></i></a>
