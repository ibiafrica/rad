...
<html>
  ...
  <head>
    ...
    <title><?php echo 'Order ID : %s &mdash; Ibi Shop Receipt' .$CODE_PROFORMA;?>
    </title>
  </head>
  <style>
    .page-header,
    ...
    <div id="container">
        ...
        <section id="memo">
          <div class="company-info">
            <section id="invoice-title-number">
              ...
              <br />
              <br />
              <span id="number"><b>N° : <?php echo $CODE_PROFORMA; ?>
                  du <?php $origDate = $DATE_CREATION_PROFORMA;
      ...
      <div class="page-footer">
        <section id="invoice-info" style="margin: 0px 0px 0 32px;">
          ...
          <div>
            <span>Nos prix sont sujets à modification en cas<br /> de variation du taux de change ou des frais
              d'approches.</span>
          </div>
                  ...
                  <table cellpadding="0" cellspacing="0">
                    ...
                    <?php
                                        ...
                                        $remise=0;
                                            ...
                                            foreach ($proforma_produits as $_produit) {
                                                $i++;
                    ...
                    <tbody>
                      <?php
                        $n=str_replace(',', '', $_produit[ 'PRIX_PROFORMA_PROD' ]);
                                                $rempl= strrev(wordwrap(strrev($n), 3, ' ', true));
                                                $nn=str_replace(',', '', number_format($_produit[ 'PRIX_TOTAL_PROFORMA_PROD' ]));
                                                $rempltotal=strrev(wordwrap(strrev($nn), 3, ' ', true));
                                                if ($_produit[ 'DISCOUNT_TYPE_PROFORMA_PROD' ] == 'percentage') {
                                                    $remises=$_produit[ 'DISCOUNT_PERCENT_PROFORMA_PROD' ];
                                                } elseif ($_produit[ 'DISCOUNT_TYPE_PROFORMA_PROD' ] == 'flat') {
                                                    $remises=$_produit[ 'DISCOUNT_AMOUNT_PROFORMA_PROD' ];
                                                } else {
                                                    $remises='0';
                                                }
                                                $remise+=$remises; ?>
                      <tr data-iterate="item">
                        ...
                        <td><?php echo $_produit[ 'NAME_PROFORMA_PROD' ]; ?>
                        </td>
                        <td><?php echo $_produit[ 'QUANTITE_PROFORMA_PROD' ]; ?>
                        </td>
                        <td><?php echo $rempl; ?>
                        </td>
                  ...
                  <section id="sums">
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr data-iterate="tax">
                        <th>TVA 18% (+)</th>
                        <?php
                                $ntva=str_replace(',', '', number_format($TVA_PROFORMA));
                      ...
                      <tr data-hide-on-quote="true">
                        <th>Total TVAC:</th>
                        <?php
                                $ntttva=str_replace(',', '', number_format($TOTAL_PROFORMA+$ntva));
