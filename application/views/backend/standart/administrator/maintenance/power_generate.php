    ...
    <div class="row" >
        <div class="col-md-12">
            ...
            <div class="presentation2">
                <h5>Date de PC : <?= date('Y-m-d H:i:s', strtotime($prise_charge['DATE_CREATION_PRISE_CHARGE'])) ?></h5>
                <h5>Date de fin : <?php 
            ...
            <div class="box">
                    ...
                    <table class="table table-bordered table-striped" id="tableId">
                        ...
                        <tbody>
                          ...
                          $article = $this->model_registers->getOne('pos_store_'.$this->uri->segment(4).'_ibi_articles', array('CODEBAR_ARTICLE'=>$value['CODE_ARTICLE_CHARGE_EQ']));
                            ...
                            $style = '';
                            if($value['QUANTITY_CHARGE_EQ'] > $article['QUANTITE_RESTANTE_ARTICLE']) {
                              $style = 'style="background: #FA5858"';
                            }

                        ?>
      
              <tr <?= $style ?> >
                <td><i class="fa fa-warning" title="La quantite dans le stock n'est pas suffisant"></i> <input type="hidden" class="codebar" name="codebar[]" value="<?=$value['CODE_ARTICLE_CHARGE_EQ']?>"><?=$value['CODE_ARTICLE_CHARGE_EQ']?></td>
                <td>
              ...
              <tfoot>
                <tr>
                  ...
                  <td><b><span class="sumTotal"><input type="hidden" name="total_prod" value="<?=$total_production?>"><?= number_format(round($total_production, 2), 0, ' ', ' ');?></span></b></td>
                </tr>
              </tfoot>
