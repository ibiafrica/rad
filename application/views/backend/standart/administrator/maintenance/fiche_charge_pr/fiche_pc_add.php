                        ...
                        <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                              <div class="panel-body">
                                <div class="row">
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="NIF_PRISE_CHARGE" id="NIF_PRISE_CHARGE" placeholder="NIF" value="<?= set_value('NIF_PRISE_CHARGE'); ?>">
                                ...
                                <div class="row">
                                  <!--<div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                      <label for="ADRESSE_CLIENT_PRISE_CHARGE" class="control-label">Adresse 
                                      </label>
                                          <input type="text" class="form-control" name="ADRESSE_CLIENT_PRISE_CHARGE" id="ADRESSE_CLIENT_PRISE_CHARGE" placeholder="Adresse" value="<?php //set_value('ADRESSE_CLIENT_PRISE_CHARGE'); ?>">
                                          <small class="info help-block">
                                          </small>
                                    </div>
                                  </div>-->
                                  <!--<div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                        <label for="DATE_SERVICE_PRISE_CHARGE" class="control-label">Date
                                        </label>
                                        <input type="date" class="form-control" name="DATE_SERVICE_PRISE_CHARGE" id="DATE_SERVICE_PRISE_CHARGE" placeholder="Date mise en service" value="<?php //set_value('DATE_SERVICE_PRISE_CHARGE'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>-->
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Personne a contacter" name="PERSONNE_CONTACT_PRISE_CHARGE" id="PERSONNE_CONTACT_PRISE_CHARGE" value="<?= set_value('PERSONNE_CONTACT_PRISE_CHARGE'); ?>">
                                      </div>
                                      <div class="col-md-6">
                                        <label for="TELEPHONE_PRISE_CHARGE">Téléphone</label>
                                        <input type="text" class="form-control" name="TELEPHONE_PRISE_CHARGE" id="TELEPHONE_PRISE_CHARGE" value="<?= set_value('TELEPHONE_PRISE_CHARGE') ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                   <div class="form-group">
                                      ...
                                      <i class="required">*</i>
                                          ...
                                          <input type="text" name="TYPE_ARTICLE_PRISE_CHARGE" class="form-control" id="TYPE_ARTICLE_PRISE_CHARGE" value="<?= set_value('TYPE_ARTICLE_PRISE_CHARGE') ?>" placeholder="Type d'Article">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                      <label for="QUANTITY_PRISE_CHARGE" class="control-label">Quantités demandées 
                                          ...
                                          <input type="text" class="form-control" name="QUANTITY_PRISE_CHARGE" id="QUANTITY_PRISE_CHARGE" placeholder="Quantités demandées" value="<?= set_value('QUANTITY_PRISE_CHARGE'); ?>">
                                          <small class="info help-block">
                                          </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="MATERIEL_PRISE_CHARGE" id="MATERIEL_PRISE_CHARGE" placeholder="Materiel" value="<?= set_value('MATERIEL_PRISE_CHARGE'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="DIMENSION_PRISE_CHARGE" id="DIMENSION_PRISE_CHARGE" placeholder="Dimensions" value="<?= set_value('DIMENSION_PRISE_CHARGE'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <input type="date" class="form-control" name="DATE_VISITE_PRISE_CHARGE" id="DATE_VISITE_PRISE_CHARGE" value="<?= set_value('DATE_VISITE_PRISE_CHARGE'); ?>">
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" id="INFO_PRISE_CHARGE" rows="3" name="INFO_PRISE_CHARGE"></textarea>
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                </div>
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                   <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="number" name="TEMPS_VALUE_FAB_PRISE_CHARGE" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                   <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="number" name="TEMPS_VALUE_LIV_PRISE_CHARGE" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                        ...
                                        <input type="date" class="form-control" name="DATE_DEB_PRISE_CHARGE" id="DATE_DEB_PRISE_CHARGE" value="<?= set_value('DATE_DEB_PRISE_CHARGE'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="DATE_LIV_PRISE_CHARGE" id="DATE_LIV_PRISE_CHARGE" value="<?= set_value('DATE_LIV_PRISE_CHARGE'); ?>">
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + 'administrator/fiche_charge/add_save/<?=$this->uri->segment(4);?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
