...
<section class="content-header">
  ...
  <ol class="breadcrumb">
      ...
      <li class=""><a  href="<?= site_url('administrator/clean/index/'.$this->uri->segment(4).''); ?>">Clean</a></li>
                        ...
                        <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                              <div class="panel-body">
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="number" name="TEMPS_VALUE_PRISE_CHARGE" value="<?= set_value('TEMPS_VALUE_PRISE_CHARGE', $prise_charge['TEMPS_VALUE_PRISE_CHARGE']); ?>" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                          <label for="TYPE_MACHINE_PRISE_CHARGE" class="control-label">Type de machine
                                          </label>
                                          <input type="text" class="form-control" name="TYPE_MACHINE_PRISE_CHARGE" id="TYPE_MACHINE_PRISE_CHARGE" placeholder="Observations spéciales" value="<?= set_value('TYPE_MACHINE_PRISE_CHARGE',  $prise_charge['TYPE_MACHINE_PRISE_CHARGE']); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      <label for="MODELE_MACHINE_CHARGE" class="control-label">Modèle
                                      </label>
                                      <div class="form-group">
                                        <input type="text" name="MODELE_MACHINE_CHARGE" id="MODELE_MACHINE_CHARGE" class="form-control" value="<?= set_value('MODELE_MACHINE_CHARGE', $prise_charge['MODELE_MACHINE_CHARGE']); ?>">
                                      </div>
                                    </div>
                                  </div>                                  
                                </div>
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      <label for="NUM_SERIE_MACHINE_CHARGE" class="control-label">N° de série
                                      </label>
                                      <div class="form-group">
                                        <input type="text" name="NUM_SERIE_MACHINE_CHARGE" id="NUM_SERIE_MACHINE_CHARGE" class="form-control" value="<?= set_value('NUM_SERIE_MACHINE_CHARGE', $prise_charge['NUM_SERIE_MACHINE_CHARGE']); ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>                        
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + '/administrator/clean/edit_save/<?=$this->uri->segment(4);?>/<?=$this->uri->segment(5);?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
