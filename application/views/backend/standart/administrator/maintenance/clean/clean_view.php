...
<section class="paper_all">
    ...
    <div class="clean_table">
        <table>
            <tr class="tr8">
                <td>Type de machine : <?= $prise_charge['TYPE_MACHINE_PRISE_CHARGE'] ?></td>
                <td>Modèle : <?= $prise_charge['MODELE_MACHINE_CHARGE'] ?></td>
                <td>N° de série : <?= $prise_charge['NUM_SERIE_MACHINE_CHARGE'] ?></td>
            </tr>
        </table>
    </div>
