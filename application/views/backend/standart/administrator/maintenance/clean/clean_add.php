                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                          ...
                                          <input type="text" class="form-control" name="TYPE_MACHINE_PRISE_CHARGE" id="TYPE_MACHINE_PRISE_CHARGE" placeholder="Observations spéciales" value="<?= set_value('TYPE_MACHINE_PRISE_CHARGE'); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <input type="text" name="MODELE_MACHINE_CHARGE" id="MODELE_MACHINE_CHARGE" class="form-control" value="<?= set_value('MODELE_MACHINE_CHARGE'); ?>">
                                      </div>
                                    </div>
                                  </div>                                  
                                </div>
                                <div class="row">
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <input type="text" name="NUM_SERIE_MACHINE_CHARGE" id="NUM_SERIE_MACHINE_CHARGE" class="form-control" value="<?= set_value('NUM_SERIE_MACHINE_CHARGE'); ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>                        
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + '/administrator/clean/add_save/<?=$this->uri->segment(4);?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
