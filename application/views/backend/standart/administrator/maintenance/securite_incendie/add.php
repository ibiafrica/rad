                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                          ...
                                          <input type="text" class="form-control" name="MOTIF_INTER_CHARGE" id="MOTIF_INTER_CHARGE" placeholder="Motif d'intervention" value="<?= set_value('MOTIF_INTER_CHARGE'); ?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group ">
                                          ...
                                          <input type="text" class="form-control" name="LIEU_INTER_CHARGE" id="LIEU_INTER_CHARGE" placeholder="Lieu d'intervention" value="<?= set_value('LIEU_INTER_CHARGE'); ?>">
                                    </div>
                                  </div>
                                </div>
                                  <div class="form-group ">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" id="CONSTAT_PRISE_CHARGE" rows="3" name="CONSTAT_PRISE_CHARGE"></textarea>
                                        <small class="info help-block">
                                        </small>
                                    </div>
                                  </div>
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + '/administrator/securite_incendie/add_save/<?=$this->uri->segment(4);?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
