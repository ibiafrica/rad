...
<section class="paper_all">
    ...
    <div class="first_table">
        <table>
            <tr class="tr1">
                ...
                <?php $type_inter = $this->db->query('SELECT * from pos_ibi_type_intervention LIMIT 4');
    ...
    <div class="second_table">
        <table>
            <tr class="tr3">
                <td>Motif d'intervention : <?= $prise_charge['MOTIF_INTER_CHARGE'] ?></td>
            </tr>
        </table>
        <table>
            <tr class="tr3">
                <td>Lieu d'intervention : <?= $prise_charge['LIEU_INTER_CHARGE'] ?></td>
            </tr>
        </table>
    </div>
    <div class="third_table">
        <table>
            <tr class="tr4">
                <td>Constant : <?= $prise_charge['CONSTAT_PRISE_CHARGE'] ?></td>
            </tr>
        </table>
    </div>
    <div class="equipment">
