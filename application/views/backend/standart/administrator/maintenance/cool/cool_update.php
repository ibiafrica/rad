                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4 col-sm-4 col-sm-offset-1">
                                    <div class="form-group TYPE_MAINTENANCE">
                                      <select  class="form-control chosen chosen-select-deselect" name="TYPE_MAINTENANCE" required>
                                        <option></option>
                                  ...
                                  <td width="200">
                                        ...
                                        <select  class="form-control chosen chosen-select-deselect EQUIPMENT_NAME" id="EQUIPMENT_NAME" data-placeholder="Selectionner l'article ">
                                          ...
                                          <?php foreach (db_get_all_data('pos_store_'.$this->uri->segment(4).'_ibi_articles') as $row):
                                            ?>
                                            <option value="<?= $row->CODEBAR_ARTICLE ?>" prix="<?= $row->PRIX_DE_VENTE_ARTICLE ?>" unite="" design="<?= $row->DESIGN_ARTICLE; ?>"><?= $row->DESIGN_ARTICLE; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <small class="info help-block">
                                        </small>
  ...
  $(document).ready(function() {
   ...
   $('#btn_save').click(function() {
      ...
      $('.message').fadeOut();
        ...
        $.ajax({
            url: BASE_URL + '/administrator/power/edit_save/<?=$this->uri->segment(4);?>/<?=$this->uri->segment(5);?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
          })
