...
<section class="content-header">
  <h1>
    Pos Ibi Fournisseurs <small><?= cclang('new', ['Pos Ibi Fournisseurs']); ?> </small>
  </h1>
  <ol class="breadcrumb">
        ...
        <div class="box-body ">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header ">
              ...
              <h5 class="widget-user-desc"><?= cclang('new', ['Pos Ibi Fournisseurs']); ?></h5>
              <hr>
            </div>
            <?= form_open('', [
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="BP_FOURNISSEUR" id="BP_FOURNISSEUR" placeholder="BP FOURNISSEUR" value="<?= set_value('BP_FOURNISSEUR'); ?>">
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="TEL_FOURNISSEUR" id="TEL_FOURNISSEUR" placeholder="TEL FOURNISSEUR" value="<?= set_value('TEL_FOURNISSEUR'); ?>">
