...
<section class="content-header">
  <h3>
  Menu du jours
    <i class="fa fa-chevron-right "></i> <small>nouvelle menu du jours </small>
  </h3>
  <ol class="breadcrumb">
          ...
          <div style="">
              ...
              <div class="col-md-4 col-md-offset-4">
                <div style="display: none; justify-content: center;">
                  <div>
                    ...
                    <label for="P" style="font-size: 15px">Patient</label>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="input-group">
                  <div class="input-group-addon">
                    Designation menu <span style="color: red">*</span>
                  </div>
                  <input type="text" class="form-control" name="DESIGNATION_MENU" id="DESIGNATION_MENU" placeholder="Entrez la designation du menu">
...
<script>
  $(document).ready(function() {
    ...
    $('.btn_save').click(function() {
      ...
      $.ajax({
          url: BASE_URL + 'administrator/pos_ibi_menu_du_jous/add_save/<?= $this->uri->segment(2) ?>',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
