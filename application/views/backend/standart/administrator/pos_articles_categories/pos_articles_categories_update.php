...
<section class="content-header">
    <h1>
        Pos Articles Categories        <small>Edit Pos Articles Categories</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Pos Articles Categories</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/pos_articles_categories/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="STORE_ID" id="STORE_ID" data-placeholder="Select STORE ID" >
                                    ...
                                    <option <?=  $row->ID_STORE ==  $pos_articles_categories->STORE_ID ? 'selected' : ''; ?> value="<?= $row->ID_STORE ?>"><?= $row->NAME_STORE; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="NOM_CATEGORIE" id="NOM_CATEGORIE" placeholder="Nom Categorie" value="<?= set_value('NOM_CATEGORIE', $pos_articles_categories->NOM_CATEGORIE); ?>">
...
<!--                                                  
                            ...
                            <div class="col-sm-8">
                                <textarea id="DESCRIPTION_CATEGORIE" name="DESCRIPTION_CATEGORIE" rows="10" cols="80"> <?= set_value('DESCRIPTION_CATEGORIE', $pos_articles_categories->DESCRIPTION_CATEGORIE); ?></textarea>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_pos_articles_categories.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#pos_articles_categories_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
