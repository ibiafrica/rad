...
<section class="content-header">
   <h1>
      Transfer      <small><?= cclang('detail', ['Transfer']); ?> </small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class=""><a  href="<?= site_url('administrator/transfert/index/'.$this->uri->segment(2)); ?>">Transfer</a></li>
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-12"> 
                        <div style="border-bottom: 1px solid #ccc7c0; border-top: 1px solid #ccc7c0; border-radius: 10px">
                          <div align="center">
                            <h4>Transfert <?=$transfert->CODE_TRANSFERT?></h4>
                          </div>
                    ...
                    <div class="view-nav">
                        <?php if ($transfert->APPROUVED_ST==0) {
                         is_allowed('pos_store_1_ibi_stock_transfert_update', function() use ($transfert){   ?>


                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit pos_store_1_ibi_stock_transfert (Ctrl+e)" href="<?= site_url('administrator/transfert/edit/'.$this->uri->segment(2).'/'.$transfert->ID_ST); ?>"><i class="fa fa-edit" ></i> Modifier </a>
                        <?php }); }?>

                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="aller a la liste" href="<?= site_url('transfert/'.$this->uri->segment(2).'/index/'); ?>"><i class="fa fa-arrow-left" ></i> </a>
                     </div>
