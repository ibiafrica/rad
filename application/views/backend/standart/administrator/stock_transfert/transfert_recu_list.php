...
<section class="content-header">
   ...
   <h3>
      <?= $this->model_rm->getOne('pos_ibi_stores', array('STATUS_STORE' => 'opened', 'ID_STORE' => $this->uri->segment(2)))['NAME_STORE'] ?> <i class="fa fa-chevron-right "></i> <small>Transfer reçu</small>
   </h3>

   <h5 class="widget-user-desc">list <i class="label bg-yellow"><?= $transfert_counts; ?> <?= cclang('items'); ?></i></h5>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Transfer reçu</li>
   </ol>
</section>
<!-- Main content -->
         ...
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <form name="form_trans" id="form_trans" action="<?= base_url('transfert_recu/'.$this->uri->segment(2).'/index'); ?>">

                     <div class="widget-user-header ">

                        <div class="pull-right" style="display: flex;">

                           <input style=" width: 300px; margin-right: 5px; text-align: center;" type="text" class="form-control" name="q" id="filter" placeholder="Rechercher" value="<?= $this->input->get('q'); ?>">
                           ...
                           <?php foreach ($transfert as $trans) : ?>
                              ...
                              <input type="checkbox" class="flat-red check" name="id[]" value="<?= $trans->ID_ST; ?>">
                                 ...
                                 <td width="100">
                                       ...
                                       <a style="margin-right: 2px" href="<?= site_url('transfert_recu/'. $this->uri->segment(2) .'/view/'. $trans->ID_ST); ?>" class="btn btn-primary btn-xs"><i class="fa fa-external-link"></i></a>
