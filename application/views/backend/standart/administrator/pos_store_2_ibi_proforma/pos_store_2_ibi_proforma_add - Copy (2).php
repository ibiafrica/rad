                        ...
                        $total_price1=($request->QUANTITE_DEVIS_PROD * $request->PRIX_DEVIS_PROD);
                         ...
                         <tr>
                           ...
                           <td colspan="" class="marge"><input type="hidden" class="form-control" name="reference[]" id="reference" placeholder="Reference" value="<?php echo $request->REF_PRODUCT_CODEBAR_DEVIS_PROD; ?>"><?php echo $request->REF_PRODUCT_CODEBAR_DEVIS_PROD; ?></td>
                            ...
                            <td class="marge text-center quantite_"><input type="hidden" class="form-control" name="quantite[]" id="quantite" placeholder="Quantite" value="<?php echo $request->QUANTITE_DEVIS_PROD; ?>">
                           <?php echo $request->QUANTITE_DEVIS_PROD; ?></td>
                          <?php  //} ?>
                            ...
                            <td class="marge text-center"><input type="hidden" class="form-control unit_price" name="unit_price[]" id="unit_price" idprix="<?php echo $request->NAME_DEVIS_PROD;?>" prixRest="<?php echo $request->PRIX_DEVIS_PROD; ?>" placeholder="Prix de vente" min="<?php echo $request->PRIX_DEVIS_PROD; ?>" value="<?php echo $request->PRIX_DEVIS_PROD; ?>"><?php echo $request->PRIX_DEVIS_PROD; ?></td>

                           <td class="marge text-center tot_price"><input type="hidden" class="form-control" name="total_price[]" readonly id="total_price" value="<?php echo ($total_price1); ?>"><?php echo ($total_price1); ?></td>
...
$total_hors_tva  = ($total_prices * 18) / 100;

$total_hors_tvac = $total_prices + $total_hors_tva;
                 ...
                 ?>
                        <tr>
                            ...
                            <td style="text-align: center;"><b><?php echo '<span class="tot_HTVA">'.number_format(round($total_prices),0," "," ").'</span> FBU'; ?></b>
                              &nbsp; &nbsp; 
                            <a data-toggle="modal" title="Ajouter une remise" data-target="#remiseId"class="btn btn-primary btn-xs"> <i class="fa fa-edit"></i> </a><input type="hidden" value="<?php echo $total_prices; ?>" name="total">
                      </td>
              ...
              <td style="text-align: center;"><b><?php echo '<span class="tva">'.number_format(round($total_hors_tva),0," "," ").'</span> FBU' ; ?></b></td>

                      </tr>

                      <tr>
                         <td style="text-align: right;" colspan="4"><b>TVAC</b></td>
                         <td style="text-align: center;"><b><?php echo '<span class="tva">' .number_format(round($total_hors_tvac),0," "," ").'</span> FBU' ; ?></b></td>
