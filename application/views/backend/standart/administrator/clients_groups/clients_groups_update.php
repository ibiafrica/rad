...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="<?= site_url('administrator/clients_groups/index/'.$this->uri->segment(4).''); ?>">Groups</a></li>
            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/clients_groups/edit_save/'.$this->uri->segment(4).'/'.$this->uri->segment(5)), [
                            'name'    => 'form_clients_groups', 
                            'class'   => 'form-horizontal', 
                            'id'      => 'form_clients_groups', 
                            'method'  => 'POST'
                            ]); ?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="DISCOUNT_TYPE_GROUP" class="col-sm-2 control-label">Type remise 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="DISCOUNT_TYPE_GROUP" id="DISCOUNT_TYPE_GROUP" data-placeholder="Selectionner le type remise" >
                                    <option value=""></option>
                                ...
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="DISCOUNT_PERCENT_GROUP" class="col-sm-2 control-label">Pourcentange remise 
                            </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="DISCOUNT_PERCENT_GROUP" id="DISCOUNT_PERCENT_GROUP" placeholder="Pourcentange remise" value="<?= set_value('DISCOUNT_PERCENT_GROUP', $clients_groups->DISCOUNT_PERCENT_GROUP); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                                                ...
                                                <div class="form-group ">
                            <label for="DISCOUNT_AMOUNT_GROUP" class="col-sm-2 control-label">Montant remise 
                            </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="DISCOUNT_AMOUNT_GROUP" id="DISCOUNT_AMOUNT_GROUP" placeholder="Montant remise" value="<?= set_value('DISCOUNT_AMOUNT_GROUP', $clients_groups->DISCOUNT_AMOUNT_GROUP); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                                                ...
                                                <div class="form-group ">
                            <label for="DISCOUNT_ENABLE_SCHEDULE_GROUP" class="col-sm-2 control-label">Activer planification 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-6">
                                ...
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="DISCOUNT_START_GROUP" class="col-sm-2 control-label">Debut planification 
                            </label>
                            <div class="col-sm-6">
                            ...
                            <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="DISCOUNT_END_GROUP" class="col-sm-2 control-label">Fin planification 
                            </label>
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/clients_groups/index/<?=$this->uri->segment(4);?>';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        var form_clients_groups = $('#form_clients_groups');
        var data_post = form_clients_groups.serializeArray();
        ...
        $.ajax({
          url: form_clients_groups.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#clients_groups_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
