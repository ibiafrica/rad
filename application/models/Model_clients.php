...
class Model_clients extends MY_Model {
	...
	private $field_search 	= ['NOM_CLIENT', 'PRENOM_CLIENT', 'TEL_CLIENT', 'EMAIL_CLIENT', 'DESCRIPTION_CLIENT','ADRESSE_CLIENT', 'CITY_CLIENT', 'COUNTRY_CLIENT', 'COMPANY_NAME_CLIENT', 'DATE_CREATION_CLIENT', 'DATE_MOD_CLIENT', 'REF_GROUP_CLIENT', 'AUTHOR_CLIENT'];
    ...
    public function join_avaiable() {
        ...
        $this->db->join('acct_compte_comptable', 'acct_compte_comptable.ID = pos_ibi_clients.NUMBER_COMPTE_CLIENT', 'LEFT');
        return $this;
    }
...
/* End of file model_clients.php */
/* Location: ./application/models/model_clients.php */