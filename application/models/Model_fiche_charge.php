...
class Model_fiche_charge extends MY_Model {

	private $primary_key 	= 'ID_PRISE_CHARGE';
	private $field_search 	= ['DEPARTEMENT_PRISE_CHARGE', 'NUMERO_PRISE_CHARGE', 'TYPE_DEMANDE_PRISE_CHARGE', 'DATE_CREATION_PRISE_CHARGE', 'DATE_MODIFIED_PRISE_CHARGE', 'AUTHOR_PRISE_CHARGE', 'MODIFIED_BY_PRISE_CHARGE'];
