   ...
   <header>
      <div class="header-content" >
         <div class="header-content-inner">
            ...
            <hr>
            <p><?= cclang('ibi_web_builder_is_used__incridible'); ?></p>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
               ...
               <hr class="light">
               <p class="text-faded"><?= cclang('ibi_made_to_facilitate__complex_application'); ?></p>
               <a href="https://codecanyon.net/item/ibi-page-form-rest-api-and-crud-generator/19207897?ref=ridwanskaterocks" class="page-scroll btn btn-default btn-xl sr-button"><?= cclang('buy_now'); ?></a>
            </div>
         </div>
      </div>
   </section>
   ...
   <aside class="bg-dark">
      <div class="container text-center">
         <div class="call-to-action">
            ...
            <a href="https://codecanyon.net/item/ibi-page-form-rest-api-and-crud-generator/19207897?ref=ridwanskaterocks" class="btn btn-default btn-xl sr-button"><?= cclang('buy_now'); ?>!</a>
         </div>
      </div>
   </aside>
