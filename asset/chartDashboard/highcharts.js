...
;(function (Z, L) {
    ...
    function (a, t) {
      ...
      t = (function () {
        ...
        w.prototype.dateFormat = function (c, d, r) {
          ...
          q(l, function (b, e) {
            for (; -1 !== c.indexOf('%' + e); )
              c = c.replace('%' + e, 'function' === typeof b ? b.call(p, d) : b)
          })
        ...
        d.prototype.addToDOM = function (c) {
          function l(c, h) {
            ...
            m(c).forEach(function (c) {
              var f = c.tagName,
                w = c.textContent ? a.doc.createTextNode(c.textContent) : void 0
              if (f)
                if ('#text' === f) var m = w
                  ...
                  I("Highcharts warning: Invalid tagName '" + f + "' in config")
              m && h.appendChild(m)
              p = m
            })
            return p
      ...
      a = (function () {
        ...
        a.prototype.destroy = function () {
          ...
          for (
            ...
            (e = d.parentGroup), b.safeRemoveChild(d.div), delete d.div, (d = e)
        ...
        a.prototype.init = function (b, e) {
          this.element = 'span' === e ? p(e) : m.createElementNS(this.SVG_NS, e)
          this.renderer = b
          n(this, 'afterInit')
        }
        ...
        a.prototype.setTextPath = function (b, e) {
          ...
          if (b && e && e.enabled) {
            ...
            n ||
              ((this.textPathWrapper = n = this.renderer.createElement(
                'textPath',
              )),
              (k = !0))
            var f = n.element
  ...
  L(a, 'Core/Renderer/RendererRegistry.js', [a['Core/Globals.js']], function (
    a,
  ) {
    var u
    ;(function (u) {
    ...
    function (a, t) {
      ...
      return (function (m) {
        ...
        h.prototype.anchorXSetter = function (d, c) {
          this.anchorX = d
          this.boxAttr(c, Math.round(d) - this.getCrispAdjust() - this.xSetting)
        }
      ...
      return (function () {
        ...
        h.prototype.truncate = function (a, c, l, f, h, p) {
          ...
          if (f + D > h) {
            ...
            0 === k
              ? (a.textContent = '')
              : (c && k === c.length - 1) || (a.textContent = g || p(c || l, b))
          }
          l && l.splice(0, b)
          d.actualWidth = D
          d.rotation = m
    ...
    function (a, t, A, G) {
      ...
      return (function (m) {
        ...
        h.prototype.html = function (d, c, l) {
          ...
          f.xSetter = f.ySetter = f.alignSetter = f.rotationSetter = function (
            c,
            a,
          ) {
        ...
        f.prototype.addLabel = function () {
          ...
          if (d.dateTime)
            if (g) {
              ...
              h(y) &&
                (u = d.dateTime.getXDateFormat(y, f.dateTimeLabelFormats || {}))
          c.isFirst = e
          c.isLast = D
          var P = {
            axis: d,
    ...
    function (a, t, A, G, x, C, I, z) {
      ...
      a = (function () {
        ...
        a.prototype.setTickInterval = function (b) {
          ...
          this.range &&
            p(this.max) &&
            ((this.userMin = this.min = B = Math.max(
              this.dataMin,
              this.minFromRange(),
            )),
        ...
        a.prototype.destroy = function (b) {
          ...
          for (var d in e.plotLinesAndBandsGroups)
            e.plotLinesAndBandsGroups[d] = e.plotLinesAndBandsGroups[
              d
            ].destroy()
          v(e, function (b, a) {
          ...
          if (0.5 <= a)
            ...
            for (
              ...
              for (n = 0; n < b && !k; n++) {
                ...
                g > d && (!h || m <= f) && 'undefined' !== typeof m && q.push(m)
                m > f && (k = !0)
                m = g
              }
            }
      ...
      t = (function () {
        ...
        d.prototype.render = function () {
          ...
          ;(w = d.plotLinesAndBandsGroups[P]) ||
            (d.plotLinesAndBandsGroups[P] = w = n
              .g('plot-' + P)
              .attr(B)
              .add())
        ...
        a.prototype.getPosition = function (b, a, e) {
          ...
          var q = !this.followPointer && y(e.ttBelow, !c.inverted === m),
            ...
            u = function (b, a, e, c, k) {
              ...
              k < d || k > a - d
                ? (f = !1)
                : (g[b] = k < e / 2 ? 1 : k > a - c / 2 ? a - c - 2 : k - e / 2)
              return f
            },
            F = function (b) {
              var a = p
    ...
    function (a, t, A, G, x) {
      ...
      t = (function () {
        ...
        g.prototype.destroy = function () {
          ...
          c && c.enabled ? (this.animateBeforeDestroy(), n(b, f.duration)) : b()
          d.pointCount--
        }
              ...
              if (b && l) {
                ...
                if (y)
                  if (u) u[g ? 'animate' : 'attr']({ x: y.x, y: y.y })
                    ...
                    k &&
                      ((e.stateMarkerGraphic = u = r.renderer
          ...
          if (!K || !K.touch)
            if (
              ...
              ;(!c.hasCartesianSeries && !c.mapView) ||
                ...
                q ||
                K ||
                ((this.selectionMarker = K = c.renderer
            ...
            (e && !d.noSharedTooltip
              ? ((n = b.filter(function (b) {
                ...
                n.forEach(function (b) {
                  ...
                  w(a) && (b.chart.isBoosting && (a = b.getPoint(a)), k.push(a))
                }))
              : k.push(m))
          h = { hoverPoint: m }
      ...
      C = (function () {
        ...
        a.prototype.proximatePositions = function () {
          ...
          this.allItems.forEach(function (e) {
            ...
            if (e.yAxis) {
              ...
              e.points &&
                (d = p(g ? e.points : e.points.slice(0).reverse(), function (
                  b,
                ) {
                  return r(b.plotY)
                }))
        ...
        a.prototype.handleOverflow = function (b) {
          ...
          b && 0 < g && b > g && !1 !== l.enabled
            ? ((this.clipHeight = F = Math.max(
                g - 20 - this.titleHeight - k,
                0,
              )),
    ...
    function (a, t, A, G, x, C, I, z, q, m, h, d, c, l, f) {
      ...
      a = (function () {
        ...
        a.prototype.getContainer = function () {
          ...
          this.renderer = new (c.renderer || !b
            ? m.getRendererType(c.renderer)
            : d)(
            e,
            k,
            h,
      ...
      a = (function () {
        ...
        a.prototype.translate = function () {
          ...
          for (B = 0; B < l; B++) {
            ...
            y.plotX = w = b(
              n(
                e.translate(t, 0, 0, 0, 1, m, 'flags' === this.type),
                -1e5,
                1e5,
              ),
            )
        ...
        a.prototype.setVisible = function (b, a) {
          var c = this,
            ...
            f = c.visible,
            k = (c.visible = b = c.options.visible = c.userOptions.visible =
      ...
      z(A, 'afterSetChartSize', function (a) {
        ...
        if (!this.renderer.forExport) {
          if (d) {
            ...
            c &&
              (this.scrollablePixelsY = d = Math.max(
                0,
                c - this.chartHeight,
              )) &&
              ((this.scrollablePlotBox = this.renderer.scrollablePlotBox = m(
      ...
      x.prototype.setStackedPoints = function (a) {
        ...
        if (
          ...
          for (x = 0; x < n; x++) {
            ...
            C.cumulative =
              'group' === c ? (C.total || 1) - 1 : f(C.cumulative, g) + (G || 0)
            null !== G &&
      ...
      G = (function (a) {
        ...
        d.prototype.getGraphPath = function (a) {
          ...
          for (q = 0; q < a.length; q++) {
            h ||
              (a[q].leftCliff = a[q].rightCliff = a[q].leftNull = a[
                q
              ].rightNull = void 0)
            var e = a[q].isNull
          ...
          if (a)
            ...
            b.group.animate(
              ...
              f(q(b.options.animation), {
                step: function (a, e) {
                  b.group && ((l[n] = m + e.pos * (c.pos - m)), b.group.attr(l))
                },
              }),
            )
          }
      ...
      a(t.prototype, {
        connectorShapes: {
          ...
          crookedLine: function (a, d, c) {
            ...
            q =
              'left' === h ? f + u + (q + p - f - u) * (1 - c) : p + (f - u) * c
            c = ['L', q, a.y]
            f = !0
        ...
        function r(a) {
          ...
          if (!f) {
            if (null !== d[0]) var h = Math.max(c[2] - Math.max(a[1], a[3]), e)
              ...
              (h = Math.max(c[2] - a[1] - a[3], e)), (c[0] += (a[3] - a[1]) / 2)
            null !== d[1]
              ? (h = m(h, e, c[2] - Math.max(a[0], a[2])))
              : ((h = m(h, e, c[2] - a[0] - a[2])), (c[1] += (a[0] - a[2]) / 2))
            h < c[2]
              ? ((c[2] = h),
